...
var path_root = "res://addons/scene_builder/data/"
...
func _create_resource(path: String):
	...
	var scene_builder_item_path1: String = "res://addons/scene_builder/scene_builder_item.gd"
	var scene_builder_item_path2: String = "res://addons/scene_builder/addons/scene_builder/scene_builder_item.gd"
	...
	if ResourceLoader.exists(path):
		...
		if collection_line_edit.text.is_empty():
			resource.collection_name = "Default"
		else:
		...
		#var image_save_path: String = path_root + resource.collection_name + "/%s.tres" % (resource.item_name + "_img")
		ResourceSaver.save(resource, save_path)
		#ResourceSaver.save(tex, image_save_path)
